...
public class Controller {
	...
	public Controller(@Qualifier("trackCoach") Coach theCoach,
			@Qualifier("trackCoach") Coach myOtherCoach) {
		this.myCoach = theCoach;
		this.myOtherCoach = myOtherCoach;
	...
	@GetMapping("/check")
	public String check() {
		return "comparing bean myCoach == myOtherCoach --> : " + (myCoach == myOtherCoach); // if bean is in singolte mode then return true , else is settting with prototype false
	}
